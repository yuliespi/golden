package golden.golden.Models.Bitacora;
...
private List<Empleado> Empleado;
    ...
    public Bitacora(Integer id, @NotEmpty String observacionesBitacora, Integer cantidadImplementosUsados,
            ...
            List<golden.golden.Models.Implemento.Implemento> implemento,
            List<golden.golden.Models.Empleado.Empleado> empleado,
            golden.golden.Models.Actividad.Actividad actividad) {
        this.id = id;
